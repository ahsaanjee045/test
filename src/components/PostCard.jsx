...
const PostCard = ({ post, active, index }) => {
  return (
    <div className={`flex-shrink-0 max-w-[280px] max-h-[390px] h-[390px] rounded-2xl bg-white overflow-hidden`}>
      <div className="h-[60%]">
        <img className="h-full" src={post.thumbnail} alt={post.title} />
      </div>
      <div className="h-[40%] px-[18px] py-[10px]">
        <h2 className="text-[14px] mb-[6px] font-semibold text-[#1c1c1c]" title={post.title}>
